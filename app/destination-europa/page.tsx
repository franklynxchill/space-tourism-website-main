...
export default function Page() {
  ...
  const europa = destinations.find(
    (destination) => destination.name === "Europa"
  )

  if (!europa) return null
        ...
        <section className=" container mx-auto lg:text-left flex  flex-col lg:flex-row items-center gap-y-20 md:gap-y-40 pb-20 lg:pb-0">
          ...
          <div className=" flex flex-col lg:flex-row gap-x-36 gap-y-20 mt-20 md:mt-36 lg:mt-52 w-full">
            ...
            <div className=" flex flex-col items-center lg:items-start justify-center ">
              <div className=" flex gap-x-7 text-lg uppercase">
              ...
              <h2>{europa.name}</h2>
              <p className=" md:w-140.5 lg:w-111 text-center lg:text-left">{europa.description}</p>
              ...
              <div className=" flex flex-col md:flex-row justify-center lg:justify-start items-center gap-y-9 gap-x-28 pt-5 mt-14 border-t-2 w-full">
                <div className="text-center lg:text-left">
                  ...
                  <span className=" text-2xl block uppercase font-bellefair mt-1.5">{europa.distance}</span>
                </div>

                <div className="text-center lg:text-left">
                  <span className=" text-sm uppercase font-barlow">Est. travel time</span>
                  <span className=" text-2xl block uppercase font-bellefair mt-1.5">{europa.travel}</span>
                </div>
              </div>
            </div>
          </div>
