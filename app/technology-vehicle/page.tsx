...
export default function Page() {
  ...
  const launchvehicle = technologies.find(
    (technology) => technology.name === "Launch vehicle"
  );

  if (!launchvehicle) return null;
      ...
      <div className="flex flex-col lg:flex-row-reverse items-center">
        <div
          className="
            ...
            lg:bg-[url('/assets/technology/image-launch-vehicle-portrait.jpg')]
          "
        ></div>
          ...
          <div>
            <div className="flex flex-col lg:flex-row gap-y-9 gap-x-20 items-center lg:items-start justify-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <h3 className="mb-6">{launchvehicle.name}</h3>
